...
public class VoltarRotacaoCabecaHandlerTests
{
    ...
    [Fact]
    public async Task HandleAsync_VoltarRotacaoCabeca_Sucesso()
    {
    ...
    [Fact]
    public async Task HandleAsync_VoltarRotacaoCabeca_RoboNaoEncontrado()
    {
        var request = new VoltarRotacaoCabecaRequest();
    ...
    [Fact]
    public async Task HandleAsync_VoltarRotacaoCabeca_AcaoNaoPermitida()
    {
    ...
    [Fact]
    public async Task HandleAsync_VoltarRotacaoCabeca_AcaoNaoPermitidaLimiteMin()
    {
        var request = new AvancarRotacaoCabecaRequest();
        var res = new ObterRoboResponse();
        var robo = new Robo();
